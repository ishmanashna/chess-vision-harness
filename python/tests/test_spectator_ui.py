...
def test_eval_ui_white_at_bottom_for_spectator():
    ui = _eval_ui(
        90,
        {"black": "Composer 2.5", "white": "Patricia 5 (800)"},
        "BLACK",
        white_at_bottom=True,
    )
    assert ui["top_label"] == "Composer 2.5"
    assert ui["bottom_label"] == "Patricia 5 (800)"
